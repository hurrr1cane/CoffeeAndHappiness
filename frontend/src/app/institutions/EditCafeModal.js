...
export default function EditCafeModal({open, id, setOpen, token, cafe}) {
    ...
    const style = {
      ...
      const handleSubmit = () => {
        axios.put(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/cafe/${id}`, formData, {
            headers: {
      ...
      const keysToDisplay = Object.keys(cafe).slice(0, -3);

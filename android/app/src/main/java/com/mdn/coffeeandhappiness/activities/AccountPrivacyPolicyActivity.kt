...
class AccountPrivacyPolicyActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setLanguage()
        setContentView(R.layout.activity_account_privacy_policy)

        val backButton = findViewById<ImageButton>(R.id.accountPrivacyPolicyActivityBackButton)

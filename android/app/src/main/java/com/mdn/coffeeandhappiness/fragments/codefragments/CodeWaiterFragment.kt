 ...
 * Use the [CodeWaiterFragment.newInstance] factory method to
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                launch(Dispatchers.Main) {
                    ...
                    val addOrders = view.findViewById<AppCompatButton>(R.id.codeWaiterPlaceOrderButton)

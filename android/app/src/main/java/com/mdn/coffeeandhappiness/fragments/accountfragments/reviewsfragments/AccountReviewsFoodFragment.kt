 ...
 * Use the [AccountReviewsFoodFragment.newInstance] factory method to
...
class AccountReviewsFoodFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AccountReviewsFoodFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AccountReviewsFoodFragment().apply {

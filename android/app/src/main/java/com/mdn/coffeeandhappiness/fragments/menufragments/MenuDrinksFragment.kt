 ...
 * Use the [MenuDrinksFragment.newInstance] factory method to
...
class MenuDrinksFragment : Fragment() {
    ...
    private fun noInternetConnection(
        ...
        val noInternet = rootView.findViewById<LinearLayout>(R.id.menuDrinksNoInternet)
    ...
    companion object {
         ...
         * @return A new instance of fragment MenuDrinksFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MenuDrinksFragment().apply {

 ...
 * Use the [AccountForgotPasswordSuccessFragment.newInstance] factory method to
...
class AccountForgotPasswordSuccessFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AccountForgotPasswordSuccess.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AccountForgotPasswordSuccessFragment().apply {
